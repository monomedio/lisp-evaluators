...
(check-equal? (eve '(((λ (x) (λ (y) 1)) 20) 300))
                '(1 #hash((E1 . ((x 20) E0))
                          ...
                          (λ0 . ((λ (x) (λ (y) 1)) E0))
                          (λ1 . ((λ (y) 1) E1)))))
; In eva, we refer to literal terms and closed λ terms (closures) as “values”.
; However, eve has its own way of evaluating λ terms. Therefore, a term is a value iff it is a literal.
(check-equal? (eve 3) '(3 #hash()))
(check-equal? (eve "jon") '("jon" #hash()))

; Evaluation of a variable is its most local value starting from the environment
; and continuing up the parent chain.
(check-equal? (eve '(((λ (x) (λ (y) x)) 20) 300))
                '(20 #hash((E1 . ((x 20) E0))
                          (E2 . ((y 300) E1))
                          (λ0 . ((λ (x) (λ (y) x)) E0))
                          (λ1 . ((λ (y) x) E1)))))

(check-equal? (eve '((((λ (x) (λ (y) (λ (z) z))) 21) 20) 300))
              '(300
                #hash((E1 . ((x 21) E0))
                      (E2 . ((y 20) E1))
                      (E3 . ((z 300) E2))
...
(check-equal? (eve '(((((λ (x) (λ (y) (λ (z) (λ (v) z)))) 400) 21) 23) 300))
              '(23
                #hash((E1 . ((x 400) E0))
                      (E2 . ((y 21) E1))
                      (E3 . ((z 23) E2))
                      (E4 . ((v 300) E3))
                      (λ0 . ((λ (x) (λ (y) (λ (z) (λ (v) z)))) E0))
                      (λ1 . ((λ (y) (λ (z) (λ (v) z))) E1))
                      (λ2 . ((λ (z) (λ (v) z)) E2))
                      (λ3 . ((λ (v) z) E3)))))

(check-equal? (eve '((λ (x) x) 300))
              '(300 #hash((E1 . ((x 300) E0))
                          (λ0 . ((λ (x) x) E0)))))

(check-equal? (eve '((((((λ (x) (λ (y) (λ (z) (λ (v) (λ (b) y))))) "p") "q") "r") "s") "t"))
              '("q"
                #hash((E1 . ((x "p") E0))
                      (E2 . ((y "q") E1))
                      (E3 . ((z "r") E2))
                      (E4 . ((v "s") E3))
                      (E5 . ((b "t") E4))
                      (λ0 . ((λ (x) (λ (y) (λ (z) (λ (v) (λ (b) y))))) E0))
                      (λ1 . ((λ (y) (λ (z) (λ (v) (λ (b) y)))) E1))
                      (λ2 . ((λ (z) (λ (v) (λ (b) y))) E2))
                      (λ3 . ((λ (v) (λ (b) y)) E3))
                      (λ4 . ((λ (b) y) E4)))))
; Evaluation of a λ term is the index of a new closure containing the term and
; environment index.
(check-equal? (eve '(λ (x) 3)) '(λ0 #hash((λ0 . ((λ (x) 3) E0)))))
